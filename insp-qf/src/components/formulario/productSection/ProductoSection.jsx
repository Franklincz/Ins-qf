...
const ProductSection = ({
    ...
    // Handlers para abrir el datepicker solo con gestos de usuario
    const handleOpenDatePickerClick = (e) => {
        if (e?.nativeEvent?.isTrusted && typeof e.target.showPicker === "function") {
            try { e.target.showPicker(); } catch {}
        }
    };

    const handleOpenDatePickerKey = (e) => {
        if ((e.key === "Enter" || e.key === " ") && typeof e.target.showPicker === "function") {
            e.preventDefault();
            try { e.target.showPicker(); } catch {}
        }
    };
            ...
            <RightColumn>
                <FieldGroup className="mb-4">
                    ...
                    <Input
                        ...
                        onClick={handleOpenDatePickerClick}   // gesto de mouse/touch
                        onKeyDown={handleOpenDatePickerKey}   // gesto de teclado
                    />
                </FieldGroup>
                <FieldGroup>
                    <Label>Lote:</Label>
