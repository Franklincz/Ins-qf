...
export default function PdfReports() {
  ...
  return (
    <div className="p-6">
      ...
      {/* Table card */}
<div className="relative overflow-hidden rounded-2xl border border-slate-200 shadow-sm dark:border-neutral-800">
  <div className="max-h-[62vh] overflow-auto">
    <table className="min-w-full text-sm">
      ...
      <tbody className="divide-y divide-slate-100 dark:divide-neutral-800">
        ...
        {/* (Opcional) indicador cuando loading en cargas subsiguientes */}
  ...
  {initialLoading && (
    <div
      className="absolute inset-0 z-20 grid place-items-center bg-white/70 backdrop-blur-sm dark:bg-neutral-900/70"
      aria-busy="true"
      aria-live="polite"
    >
